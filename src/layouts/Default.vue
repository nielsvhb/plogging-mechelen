    ...
    <div class="flex flex-col min-h-screen font-body">
      <header class="items-center bg-white pt-4 sm:pt-0">
        <div class="mx-auto container justify-between flex">
          <div class="py-2">
            <g-link to="/"><g-image src="/logo.png" :alt="$static.metadata.siteName" class="w-96 lg:w-60 md:w-44 sm:w-56"></g-image></g-link>
          </div>
          ...
          <div class="flex sm:block sm:space-y-6">
              ...
              <div class="flex-col w-1/2 sm:w-full">
                ...
                <form 
                  ...
                  method="post">
                  <input name="email" type="email" v-model="email" class="rounded-l px-4 py-2 w-80" placeholder="E-mailadres" />
                  <button type="submit" class="rounded-r bg-light-blue-500 text-white py-2 px-8 tracking-wide font-semibold inline-block text-lg"><i class="fas fa-paper-plane"></i></button>
                </form>
